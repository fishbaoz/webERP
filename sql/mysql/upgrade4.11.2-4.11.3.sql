...
ALTER TABLE weberp_ `emailsettings` CHANGE  `username`  `username` VARCHAR( 50 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;
CREATE TABLE weberp_IF NOT EXISTS `pricematrix` (
...
ALTER table stockmoves CHANGE reference reference varchar(100) NOT NULL DEFAULT '';
ALTER TABLE weberp_bom ADD COLUMN sequence INT(11) NOT NULL DEFAULT 0 AFTER parent;
INSERT INTO weberp_scripts VALUES('TopCustomers.php',1,'Shows the top customers');
