...
$Title = _('Upload a webERP plugin');

include('includes/header.inc');

echo '<p class="page_title_text noPrint" ><img src="' . $RootPath . '/css/' . $Theme . '/images/upload.png" title="' . _('Upload Plugin') . '" alt="" />' . _('Upload webERP Plugin') . '</p>';
...
if (!isset($_POST['submit'])) {
	...
	echo '<div class="page_help_text noPrint">' . _('Use this screen to upload a webERP plugin file to your plugins directory. The file should be of type *.zip') . '</div>';
